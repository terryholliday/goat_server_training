import type { InfoPage, SequenceStep, Term, MCQ, SectionDefinition } from './types';
...
export const CULINARY_TERMS: Term[] = [
  { term: "Almondine", pronunciation: "ahl-mon-DEEN", definition: "A garnish of almonds, usually cooked with butter and seasonings, then sprinkled with whole or flaked, toasted almonds.", image: `${BASE_IMG_PATH}almondine.png` },
  { term: "Arugula Pesto", pronunciation: "ah-ROO-guh-lah PEH-stoh", definition: "A sauce made of basil, arugula, garlic confit, pistachios, grated Reggiano cheese and sea salt.", image: `${BASE_IMG_PATH}arugula_pesto.png` },
  { term: "Baby Garbanzo", pronunciation: "BAY-bee gar-BAHN-zo", definition: "A bright yellow legume with a nutty texture and mild flavor, resembling a corn kernel when cooked.", image: `${BASE_IMG_PATH}baby_garbanzo.png` },
  { term: "Béarnaise", pronunciation: "bear-NAIZ", definition: "A sauce made of clarified butter, egg yolks, and herbs, traditionally tarragon.", image: `${BASE_IMG_PATH}bearnaise.png` },
  { term: "Béchamel", pronunciation: "beh-shah-MEL", definition: "A white sauce made from milk and a roux (flour and butter). A mother sauce of French cuisine.", image: `${BASE_IMG_PATH}bechamel.png` },
  { term: "Beurre Blanc", pronunciation: "burr BLAHNK", definition: "A seasoned butter sauce flavored with white wine, shallots, and vinegar or lemon juice.", image: `${BASE_IMG_PATH}beurre_blanc.png` },
  { term: "Blood Orange", pronunciation: "bluhd OR-inj", definition: "A variety of orange with crimson, almost-blood-colored flesh and a flavor profile that can include notes of raspberry.", image: `${BASE_IMG_PATH}blood_orange.png` },
  { term: "Bordelaise Sauce", pronunciation: "bor-duh-LAIZ", definition: "A classic French sauce consisting of stock thickened with roux and flavored typically with red wine and shallots.", image: `${BASE_IMG_PATH}bordelaise.png` },
  { term: "Bouillabaisse", pronunciation: "BOO-yuh-bays", definition: "A traditional Provençal fish stew originating from Marseille. Typically made with various fish, shellfish, vegetables, and herbs, flavored with saffron and served with rouille and toast.", image: `${BASE_IMG_PATH}bouillabaisse.png` },
  { term: "Brioche", pronunciation: "BREE-ohsh", definition: "A highly enriched French bread made with eggs and butter. It has a light, fluffy texture and a slightly sweet flavor.", image: `${BASE_IMG_PATH}brioche.png` },
  { term: "Broccolini", pronunciation: "brok-o-LEE-nee", definition: "A green vegetable similar to broccoli but with smaller florets and longer, thin stalks. A hybrid of broccoli and kai-lan.", image: `${BASE_IMG_PATH}broccolini.png` },
  { term: "Brown Butter", pronunciation: "brown BUT-ter", definition: "Butter that has been heated in a pan until the milk solids turn a light brown color, creating a nutty flavor and aroma.", image: `${BASE_IMG_PATH}brown_butter.png` },
  { term: "Brunoise", pronunciation: "broon-WAHZ", definition: "A culinary knife cut in which ingredients are cut into small cubes of 1/8 inch (3mm) on each side.", image: `${BASE_IMG_PATH}brunoise.png` },
  { term: "Celeriac", pronunciation: "seh-LEH-ree-ak", definition: "Also called turnip-rooted celery or knob celery, it is a variety of celery cultivated for its edible roots.", image: `${BASE_IMG_PATH}celeriac.png` },
  { term: "Chanterelle", pronunciation: "shan-tuh-REL", definition: "Trumpet-shaped mushrooms with a mild, nutty flavor and chewy texture, often with an apricot-like aroma.", image: `${BASE_IMG_PATH}chanterelle.png` },
  { term: "Chantilly Cream", pronunciation: "shan-TIL-ee kreem", definition: "A sweetened whipped cream, often flavored with vanilla.", image: `${BASE_IMG_PATH}chantilly_cream.png` },
  { term: "Charcuterie", pronunciation: "shar-koo-tuh-REE", definition: "A branch of cooking devoted to prepared meat products, such as bacon, ham, sausage, terrines, pâtés, and confit.", image: `${BASE_IMG_PATH}charcuterie.png` },
  { term: "Chasseur Sauce", pronunciation: "shah-SUR", definition: "A simple or compound brown sauce used in French cuisine, often including mushrooms, shallots, tomatoes, and tarragon.", image: `${BASE_IMG_PATH}chasseur_sauce.png` },
  { term: "Chiffonade", pronunciation: "shif-oh-NAHD", definition: "A culinary knife cut where leafy greens or herbs are cut into long, thin strips.", image: `${BASE_IMG_PATH}chiffonade.png` },
  { term: "Chèvre", pronunciation: "SHEV-ruh", definition: "Goat cheese.", image: `${BASE_IMG_PATH}chevre.png` },
  { term: "Confit", pronunciation: "kon-FEE", definition: "A cooking technique where food (like duck or garlic) is slowly poached in fat or oil at a low temperature.", image: `${BASE_IMG_PATH}duck_confit.png` },
  { term: "Consommé", pronunciation: "kon-soo-MAY", definition: "A clear, strongly flavored soup or broth that has been clarified, often through the use of a raft of egg whites and ground meat.", image: `${BASE_IMG_PATH}consomme.png` },
  { term: "Crème Anglaise", pronunciation: "krem ahn-GLAIZE", definition: "A light pouring custard made from a mixture of sugar, egg yolks, and hot milk, often flavored with vanilla.", image: `${BASE_IMG_PATH}creme_anglaise.png` },
  { term: "Crème Brûlée", pronunciation: "krem broo-LAY", definition: "A dessert consisting of a rich custard base topped with a layer of hardened caramelized sugar.", image: `${BASE_IMG_PATH}creme_brulee.png` },
  { term: "Crème Fraîche", pronunciation: "krem FRESH", definition: "A thick, tangy cultured cream with a high fat content. Similar to sour cream but richer and less tangy.", image: `${BASE_IMG_PATH}creme_fraiche.png` },
  { term: "Duxelles", pronunciation: "dooks-ELL", definition: "A finely chopped mixture of mushrooms, onions, shallots, and herbs sautéed in butter until reduced to a paste.", image: `${BASE_IMG_PATH}duxelles.png` },
  { term: "En Croute", pronunciation: "ahn KROOT", definition: "A French term meaning 'in crust,' referring to food wrapped in pastry and baked.", image: `${BASE_IMG_PATH}en_croute.png` },
  { term: "EVOO", pronunciation: "ee-vee-oh-oh", definition: "An acronym for Extra Virgin Olive Oil, the highest quality of olive oil.", image: `${BASE_IMG_PATH}evoo.png` },
  { term: "Fines Herbes", pronunciation: "feen-Z-ERB", definition: "A classic mixture of herbs used as seasoning or garnish, typically including parsley, chives, tarragon, and chervil.", image: `${BASE_IMG_PATH}fines_herbes.png` },
  { term: "Flambé", pronunciation: "flahm-BAY", definition: "A cooking procedure in which alcohol is added to a hot pan to create a burst of flames.", image: `${BASE_IMG_PATH}flambe.png` },
  { term: "Fleur de Sel", pronunciation: "flur duh SEL", definition: "A French gray salt - hand-harvested sea salt collected off the coast of Brittany.", image: `${BASE_IMG_PATH}fleur_de_sel.png` },
  { term: "Foie Gras", pronunciation: "fwah GRAH", definition: "The liver of a specially fattened duck or goose. It is a rich, buttery delicacy.", image: `${BASE_IMG_PATH}foie_gras.png` },
  { term: "Frisée", pronunciation: "free-ZAY", definition: "Curly leaves of baby endive lettuce with a slightly bitter taste.", image: `${BASE_IMG_PATH}frisee.png` },
  { term: "Frites", pronunciation: "FREET", definition: "French fries.", image: `${BASE_IMG_PATH}frites.png` },
  { term: "Gelee", pronunciation: "zhuh-LAY", definition: "A firm jelly made with different spices and flavorings, often from stock.", image: `${BASE_IMG_PATH}gelee.png` },
  { term: "Julienne", pronunciation: "joo-lee-EN", definition: "A culinary knife cut in which food items are cut into long thin strips, like matchsticks.", image: `${BASE_IMG_PATH}julienne.png` },
  { term: "Mirepoix", pronunciation: "meer-PWAH", definition: "A flavor base made from diced vegetables cooked slowly with butter or oil. The traditional French mirepoix consists of two parts onion, one part carrot, and one part celery.", image: `${BASE_IMG_PATH}mirepoix.png` },
  { term: "Mousse", pronunciation: "mooss", definition: "A soft prepared food that incorporates air bubbles to give it a light, airy texture. It can be sweet or savory.", image: `${BASE_IMG_PATH}mousse.png` },
  { term: "Pâté", pronunciation: "pah-TAY", definition: "A mixture of ground meat and fat minced into a spreadable paste.", image: `${BASE_IMG_PATH}pate.png` },
  { term: "Ratatouille", pronunciation: "ra-tuh-TOO-ee", definition: "A traditional Provençal stewed vegetable dish originating from Nice.", image: `${BASE_IMG_PATH}ratatouille.png` },
  { term: "Rouille", pronunciation: "ROO-ee", definition: "A sauce that consists of olive oil with breadcrumbs, garlic, saffron, and chili peppers. It is traditionally served with fish soup.", image: `${BASE_IMG_PATH}rouille.png` },
  { term: "Soubise", pronunciation: "soo-BEEZ", definition: "A thick white sauce or puree made with onions and Béchamel or cream.", image: `${BASE_IMG_PATH}soubise.png` },
];
